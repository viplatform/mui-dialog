...
import React__default, { forwardRef, useContext, isValidElement, cloneElement, Children } from 'react';
...
function createPalette(palette) {
  const {
    ...
    other = _objectWithoutPropertiesLoose(palette, _excluded$h);
...
const Fade = /*#__PURE__*/React.forwardRef(function Fade(props, ref) {
  ...
  return /*#__PURE__*/jsx$1(TransitionComponent, _extends$1({
    appear: appear,
    in: inProp,
    nodeRef: nodeRef ,
    onEnter: handleEnter,
...
const Backdrop = /*#__PURE__*/React.forwardRef(function Backdrop(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(TransitionComponent, _extends$1({
    ...
    children: /*#__PURE__*/jsx$1(BackdropRoot, _extends$1({
      "aria-hidden": true
    }, rootSlotProps, {
...
const Modal = /*#__PURE__*/React.forwardRef(function Modal(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(Portal, {
    ...
    children: /*#__PURE__*/jsxs(RootSlot, _extends$1({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? /*#__PURE__*/jsx$1(BackdropSlot, _extends$1({}, backdropProps)) : null, /*#__PURE__*/jsx$1(FocusTrap, {
...
const Paper = /*#__PURE__*/React.forwardRef(function Paper(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(PaperRoot, _extends$1({
    as: component,
...
const Dialog = /*#__PURE__*/React.forwardRef(function Dialog(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(DialogRoot, _extends$1({
    className: clsx(classes.root, className),
    ...
    children: /*#__PURE__*/jsx$1(TransitionComponent, _extends$1({
      appear: true,
      in: open,
      timeout: transitionDuration,
      role: "presentation"
      ...
      children: /*#__PURE__*/jsx$1(DialogContainer, {
        ...
        ownerState: ownerState,
        children: /*#__PURE__*/jsx$1(DialogPaper, _extends$1({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState: ownerState,
          children: /*#__PURE__*/jsx$1(DialogContext.Provider, {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /*#__PURE__*/jsx$1(SvgIcon, _extends$1({
...
const CircularProgress = /*#__PURE__*/React.forwardRef(function CircularProgress(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(CircularProgressRoot, _extends$1({
    className: clsx(classes.root, className),
    style: _extends$1({
      width: size,
      height: size
...
const _excluded$2 = ["children", "disabled", "id", "loading", "loadingIndicator", "loadingPosition", "variant"];
...
const LoadingButton = /*#__PURE__*/React.forwardRef(function LoadingButton(inProps, ref) {
  ...
  const loadingIndicator = loadingIndicatorProp != null ? loadingIndicatorProp : /*#__PURE__*/jsx$1(CircularProgress, {
    "aria-labelledby": id,
    color: "inherit",
    size: 16
  });
  ...
  const loadingButtonLoadingIndicator = loading ? /*#__PURE__*/jsx$1(LoadingButtonLoadingIndicator, {
...
const Divider = /*#__PURE__*/React.forwardRef(function Divider(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(DividerRoot, _extends$1({
    as: component,
    className: clsx(classes.root, className),
    role: role,
    ref: ref,
    ...
    children: children ? /*#__PURE__*/jsx$1(DividerWrapper, {
...
const checkIfTertiaryCtaIsAllowed = (type, subtype, size) => {
    if (type === MODAL_TYPES.CONFIRMATION)
        return false;
    if (subtype === INFORMATION_SUBTYPES.ACKNOWLEDGEMENT)
        return false;
    if (size === MODAL_SIZES.SMALL)
        return false;
    return true;
};
...
const TransitionUp = forwardRef(function Transition(props, ref) {
    return jsx$1(Slide, { direction: 'up', ref: ref, ...props });
});
const ViDialog = (props) => {
    const theme = useTheme();
    const isMobile = useMediaQuery(theme.breakpoints.down('sm'));
    const subtype = props.type === MODAL_TYPES.INFORMATION
        ? props.subtype
        : props.type === MODAL_TYPES.CONFIRMATION
            ...
            : props.type === MODAL_TYPES.INPUT
                ? props.subtype
                : 'default';
    const { wrapperClassName, open, type, size, title, subTitle, description, onClose, children, actions, showActions = true, showDivider = true, showCloseIcon = true, tertiaryCtaType = 'default', ...rest } = props;
    const { primaryCtaTitle, secondaryCtaTitle, isPrimaryCtaLoading = false, isPrimaryCtaDisabled = false, isSecondaryCtaDisabled = false, onPrimaryCtaClick = _noop, onSecondaryCtaClick = _noop, tertiaryCtaTitle, tertiaryCtaStartIcon, isTertiaryCtaLoading = false, isTertiaryCtaDisabled = false, onTertiaryCtaClick = _noop, } = actions || {};
    ...
    return (jsx$1(Dialog, { TransitionComponent: isMobile ? TransitionUp : undefined, className: `vi-dialog ${MODAL_SIZE_VS_CLASS_NAMES[selectedSize]} ${wrapperClassName}`, open: open, onClose: handleClose, maxWidth: SIZE_TO_MAX_WIDTH[selectedSize], fullWidth: true, ...rest, children: jsxs("div", { className: 'p-24 h-fill', children: [title && (jsxs("div", { className: `vi-dialog-title ${MODAL_SIZE_VS_CLASS_NAMES[selectedSize]}`, children: [jsxs("div", { className: 'd-f ai-c jc-sb', children: [jsxs("div", { className: 'd-f flex-dir-col gap-8', children: [jsx$1(Typography, { variant: 'semiBoldLabelL', children: title }), subTitle && jsx$1(Typography, { variant: 'subtextM', children: subTitle })] }), showCloseIcon && (jsx$1(CloseIcon, { fontSize: 'small', className: 'close-icon', "aria-label": 'Close dialog', onClick: onClose }))] }), description && (jsx$1(Typography, { component: 'div', className: 'description', variant: 'subtextM', children: description }))] })), children, showFooter && (jsxs(Fragment, { children: [showFooterDivider && jsx$1(Divider, { className: 'divider' }), showTertiaryCta ? (jsxs("div", { className: 'vi-dialog-actions-wrapper', children: [jsx$1(LoadingButton, { className: `tertiary-cta ${tertiaryCtaType === TERTIARY_CTA_TYPES.DESTRUCTIVE ? 'destructive' : ''}`, variant: 'text', onClick: onTertiaryCtaClick, loading: isTertiaryCtaLoading, disabled: isTertiaryCtaDisabled, startIcon: tertiaryCtaStartIcon, children: tertiaryCtaTitle }), jsxs("div", { className: `vi-dialog-actions ${MODAL_SIZE_VS_CLASS_NAMES[selectedSize]}`, children: [secondaryCtaTitle && (jsx$1(Button, { className: 'vi-dialog-cta', variant: 'outlined', onClick: onSecondaryCtaClick, disabled: isSecondaryCtaDisabled, children: secondaryCtaTitle })), primaryCtaTitle && (jsx$1(LoadingButton, { className: `vi-dialog-cta ${subtype === 'destructive' ? 'destructive' : ''}`, variant: 'contained', onClick: onPrimaryCtaClick, loading: isPrimaryCtaLoading, disabled: isPrimaryCtaDisabled, children: primaryCtaTitle }))] })] })) : (jsxs("div", { className: `vi-dialog-actions without-tertiary ${MODAL_SIZE_VS_CLASS_NAMES[selectedSize]}`, children: [secondaryCtaTitle && (jsx$1(Button, { className: 'vi-dialog-cta', variant: 'outlined', onClick: onSecondaryCtaClick, disabled: isSecondaryCtaDisabled, children: secondaryCtaTitle })), primaryCtaTitle && (jsx$1(LoadingButton, { className: `vi-dialog-cta ${subtype === 'destructive' ? 'destructive' : ''}`, variant: 'contained', onClick: onPrimaryCtaClick, loading: isPrimaryCtaLoading, disabled: isPrimaryCtaDisabled, children: primaryCtaTitle }))] }))] }))] }) }));
};
